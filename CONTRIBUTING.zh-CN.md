...
不要粘贴连接码、分享链接、恢复令牌、TURN 密码、Turnstile secret、真实 IP、完整 SDP 或 ICE Candidate。安全问题请按 [SECURITY.zh-CN.md](./SECURITY.zh-CN.md) 私下报告。
...
6. 更新与改动直接相关的文档，并同步默认英文 `.md` 与中文 `.zh-CN.md`。
